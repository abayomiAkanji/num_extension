...
void main() {
  ...
  group('NumExtension', () {
    ...
    group('List<num>', () {
      ...
      test('Can not determine the minimum value in a `List` when it contain < 2 element', (){
        expect(() => [2].min, throwsException);
      });

      test('Can not determine the maximum value in a `List` when it contain < 2 element', (){
